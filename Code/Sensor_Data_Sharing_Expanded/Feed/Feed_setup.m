...
ind=strmatch(['Line',num2str(feed_id)],out{1},'exact');
if length(ind) > 1
     ind=ind(1);
end 
...
disp('Beginning Physical Inialisations')
toc 
...
disp('Finished Initialising the Lift'0
toc 
...
reset.Stop('off',load);
disp('Finished Pusher Inialisation')
toc 
