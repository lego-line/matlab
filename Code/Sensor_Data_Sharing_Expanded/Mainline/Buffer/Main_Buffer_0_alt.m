...
% N.B.  uses the alternative light sensor at the end of the transfer line
% to detect pallets entering the mainline. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   % case for if there is not yet any dowsntream data to be had 
   if Running_2 ==1 && downstream_transfer == 0
   ...
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   if Running_2 ==1 && downstream_transfer == 1 && No_pallets_mainline2 == 0 
        disp('The Double Belt Has Stopped')
        % change the flag to show that the belt has stopped 
        conveyor_2_STOP.SendToNXT(Main);
        Running_2 = 0 ; 
