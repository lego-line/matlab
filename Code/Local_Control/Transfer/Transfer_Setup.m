...
disp('Beginning to Setup Running Variables')
toc 
...
disp('Finished The Platform Initialisation')
toc 
...
tic
disp('Finished Initialising Transfer Unit Arm')
toc
...
add = NXTMotor('B','Power', -11, 'TachoLimit',125); %Load block
