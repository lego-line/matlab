...
if 	feeding2 == 1 
    ...
    if  motoron.IsRunning == 0  % 05/10/11: Checks when have just finished moving pallet with conveyor from 'a' to 'b'.
        ...
        disp('Feed conveyor stopped so assume pallet succesfully moved from a to b')   
    end
end
