...
% set the fast track belt speed
eval(['Belt_Speed_',num2str(feed_id),' = 0;'])
...
disp('Completed Lift Initialisaton')
toc 
...
pos=0;
pos2=1;
disp('Completed Pusher Initailisation')
toc 
...
disp('Finished Setting Up Commands')
toc 
