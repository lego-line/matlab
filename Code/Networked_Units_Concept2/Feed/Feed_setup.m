...
tic;
Failure_Flag =0; % flah which tarcks if a critical ailure has occured on this unit 
fault_flag = 0; % flag to track if a fuult is detected and error correction is in progress
fault_matrix = []; 
...
toc 
%% Physical inialisations
disp('Starting Physical inialisations')
toc 
...
disp('Completed inialisation of Lifeter Mechanism')
toc 
...
disp('Finished Setting Up Pusher Mechanism')
toc
disp('Completed Physical inialisations')
toc 
